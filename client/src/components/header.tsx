      ...
      <div className="container mx-auto flex h-14 md:h-16 items-center justify-between gap-4 px-4">
        <Link href="/" data-testid="link-home">
          <div className="flex items-center gap-3 hover-elevate rounded-md px-2 py-1 cursor-pointer">
            ...
            <div className="block">
              <h1 className="text-base md:text-lg font-semibold tracking-tight">Heard</h1>
              <p className="text-xs text-muted-foreground hidden sm:block">Anonymous Church Experiences</p>
            </div>
          </div>
        </Link>
