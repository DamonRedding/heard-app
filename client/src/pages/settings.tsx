...
import { ArrowLeft, Shield, Heart, Users, Lock, Scale, Eye, Sun, Moon, Monitor, Palette } from "lucide-react";
    ...
    <div className="min-h-screen safe-area-inset-top">
      <div className="container mx-auto px-4 py-8 max-w-3xl">
        ...
        <div className="space-y-8">
          ...
          <section>
            <h2 className="text-xl font-semibold mb-4">About Heard</h2>
            <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
              <div>
                <h3 className="text-lg font-medium mb-2">Why This Exists</h3>
              ...
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-medium">Community Responds</h4>
                      <p className="text-sm text-muted-foreground">
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h4 className="font-medium">Accountability Grows</h4>
                      <p className="text-sm text-muted-foreground">
